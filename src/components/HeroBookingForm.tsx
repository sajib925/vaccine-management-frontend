...
const HeroBookingForm: React.FC<HeroText> = (props) => {
  return (
    <section className={`relative mb-10 lg:mb-20 py-20 lg:py-44 px-4 bg-gray-100 bg-[url('/image/vaccine-4.jpg')] bg-cover bg-center bg-no-repeat`}>
      {/* Overlay */}
