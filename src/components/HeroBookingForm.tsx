    ...
    return (
        <section className={`relative mb-10 lg:mb-20 pt-52 lg:py-44 px-4 bg-gray-100 bg-[url('/image/contact.jpg')] bg-cover bg-top bg-no-repeat`}>
            ...
            <div className="relative max-w-screen-xl w-full mx-auto">
                <div className="lg:max-w-[600px] w-full py-12 lg:py-24 lg:px-16 rounded-lg bg-white max-lg:flex flex-col items-center">
                    <h1 className="text-4xl lg:text-7xl font-bold mb-4 text-[#111]">All Bookings</h1>
