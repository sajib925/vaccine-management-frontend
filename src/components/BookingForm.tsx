...
const fetchCampaigns = async () => {
  ...
  const res = await axios.get<Campaign[]>('https://vaccine-management-supebase.vercel.app/api/campaign/', {
...
const fetchVaccines = async () => {
  ...
  const res = await axios.get<Vaccine[]>('https://vaccine-management-supebase.vercel.app/api/campaign/vaccine/', {
    headers: { Authorization: `Token ${token}` },
  });
  return res.data;
};
...
const postBookingData = async (data: BookingData) => {
  ...
  const response = await axios.post('https://vaccine-management-supebase.vercel.app/api/booking/', {
